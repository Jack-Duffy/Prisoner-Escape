...
class GameLevelPrisonEscape {
  constructor(path) {
    ...
    src: "MainCharecter.png",  // Ensure this matches the actual sprite file path
    SCALE_FACTOR: 2,  // Adjust based on display needs
    STEP_FACTOR: 1000,
    ANIMATION_RATE: 100,  // Slightly slower for better visibility
    INIT_POSITION: { x: 0, y: height - (height / 2) },  // Adjusted based on scale
    pixels: { height: 950, width: 644 },
    orientation: { rows: 4, columns: 4 },
    frameSize: { width: 161, height: 237 },
    down: { row: 0, start: 0, columns: 4 },  // Ensuring all frames are used
